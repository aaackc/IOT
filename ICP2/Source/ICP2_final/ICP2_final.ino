...
#define SSID "ABC"     // "SSID-WiFiname" 
#define PASS "12345678"       // "password"
#define IP "184.106.153.149"// thingspeak.com ip
String msg = "GET /update?key=5XVYVCOZLZK6OFI6"; //change it with your api key like "GET /update?key=Your Api Key"
...
void loop(){
  ...
  lcd.display();
  lcd.setCursor(0, 0);
  if(BPM<300 && BPM>50){          //Reset if over or below 150 or 50
    lcd.print("BPM = ");
    lcd.print(BPM);
  }
